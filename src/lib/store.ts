...
export const useStore = create<AppState>()(
  persist(
    (set, get) => ({
          ...
          try {
            ...
            set({
              ...
              settings: {
                ...
                accentColor: settings?.accent_color || 'orange',
                fontSize: settings?.font_size || 'medium',
                notifications: settings?.notifications ?? true,
                pomodoroWork: settings?.pomodoro_work || 25,
      ...
      addExam: async (exam) => {
        const userId = get().userId || '';
        const examWithUserId = { ...exam, userId };
        ...
        if (isSupabaseConfigured()) {
          ...
          if (!error) {
            set((state) => ({ exams: [...state.exams, examWithUserId] }));
          }
        } else {
          set((state) => ({ exams: [...state.exams, examWithUserId] }));
        }
      ...
      addStudySession: async (session) => {
        ...
        if (isSupabaseConfigured()) {
          ...
          if (!error) {
            set((state) => ({ studySessions: [...state.studySessions, sessionWithUserId] }));
          }
        } else {
          set((state) => ({ studySessions: [...state.studySessions, sessionWithUserId] }));
        }
      ...
      addTask: async (task) => {
        ...
        if (isSupabaseConfigured()) {
          ...
          if (!error) {
            set((state) => ({ tasks: [...state.tasks, taskWithUserId] }));
          }
        } else {
          set((state) => ({ tasks: [...state.tasks, taskWithUserId] }));
        }
      ...
      addPomodoroSession: async (session) => {
        ...
        if (isSupabaseConfigured()) {
          ...
          if (!error) {
            set((state) => ({ pomodoroSessions: [...state.pomodoroSessions, sessionWithUserId] }));
          }
        } else {
          set((state) => ({ pomodoroSessions: [...state.pomodoroSessions, sessionWithUserId] }));
        }
      ...
      addGrade: async (grade) => {
        const userId = get().userId || '';
        const gradeWithUserId = { ...grade, userId };
        ...
        if (isSupabaseConfigured()) {
          ...
          if (!error) {
            set((state) => ({ grades: [...state.grades, gradeWithUserId] }));
          }
        } else {
          set((state) => ({ grades: [...state.grades, gradeWithUserId] }));
        }
      ...
      addFlashcardDeck: async (deck) => {
        const userId = get().userId || '';
        const deckWithUserId = { ...deck, userId };
        ...
        if (isSupabaseConfigured()) {
          ...
          if (!error) {
            set((state) => ({ flashcardDecks: [...state.flashcardDecks, deckWithUserId] }));
          }
        } else {
          set((state) => ({ flashcardDecks: [...state.flashcardDecks, deckWithUserId] }));
        }
      ...
      addNote: async (note) => {
        ...
        if (isSupabaseConfigured()) {
          ...
          if (!error) {
            set((state) => ({ notes: [...state.notes, noteWithUserId] }));
          }
        } else {
          set((state) => ({ notes: [...state.notes, noteWithUserId] }));
        }
      ...
      addHabit: async (habit) => {
        ...
        if (isSupabaseConfigured()) {
          ...
          if (!error) {
            set((state) => ({ habits: [...state.habits, habitWithUserId] }));
          }
        } else {
          set((state) => ({ habits: [...state.habits, habitWithUserId] }));
        }
      ...
      addResource: async (resource) => {
        const userId = get().userId || '';
        const resourceWithUserId = { ...resource, userId };
        ...
        if (isSupabaseConfigured()) {
          ...
          if (!error) {
            set((state) => ({ resources: [...state.resources, resourceWithUserId] }));
          }
        } else {
          set((state) => ({ resources: [...state.resources, resourceWithUserId] }));
        }
      ...
      addGoal: async (goal) => {
        ...
        if (isSupabaseConfigured()) {
          ...
          if (!error) {
            set((state) => ({ goals: [...state.goals, goalWithUserId] }));
          }
        } else {
          set((state) => ({ goals: [...state.goals, goalWithUserId] }));
        }
      ...
      addSleepLog: async (log) => {
        const userId = get().userId || '';
        const logWithUserId = { ...log, userId };
        ...
        if (isSupabaseConfigured()) {
          ...
          if (!error) {
            set((state) => ({ sleepLogs: [...state.sleepLogs, logWithUserId] }));
          }
        } else {
          set((state) => ({ sleepLogs: [...state.sleepLogs, logWithUserId] }));
        }
      ...
      addTimetableEntry: async (entry) => {
        ...
        if (isSupabaseConfigured()) {
          ...
          if (!error) {
            set((state) => ({ timetable: [...state.timetable, entryWithUserId] }));
          }
        } else {
          set((state) => ({ timetable: [...state.timetable, entryWithUserId] }));
        }
      ...
      addChatMessage: async (message) => {
        ...
        if (isSupabaseConfigured()) {
          ...
          if (!error) {
            set((state) => ({ chatHistory: [...state.chatHistory, messageWithUserId] }));
          }
        } else {
          set((state) => ({ chatHistory: [...state.chatHistory, messageWithUserId] }));
        }
      ...
      addActivity: async (activity) => {
        ...
        if (isSupabaseConfigured()) {
          ...
          if (!error) {
            set((state) => ({
              activities: [activityWithUserId, ...state.activities].slice(0, 50)
            }));
          }
        } else {
          set((state) => ({
        ...
        try {
          ...
          if (isSupabaseConfigured() && userId) {
            ...
            set({
              ...
              settings: { ...defaultSettings, ...parsed.settings, userId: get().userId },
            });
            return true;
          }
        } catch {
